...
public class DataInitializer {
    ...
    public static Consultation[] initializeSampleConsultations() {
        ...
        consultations[0] = new Consultation("CON001", "1", "DOC001", "10-07-2025", "completed", "Patient shows signs of hypertension", "20-07-2025");
        consultations[1] = new Consultation("CON002", "2", "DOC002", "12-07-2025", "scheduled", "Regular checkup", "25-07-2025");
        consultations[2] = new Consultation("CON003", "3", "DOC003", "15-07-2025", "completed", "Neurological examination completed", "30-07-2025");
        consultations[3] = new Consultation("CON004", "4", "DOC005", "16-07-2025", "completed", "Diabetes management consultation", "26-07-2025");
        consultations[4] = new Consultation("CON005", "5", "DOC001", "17-07-2025", "scheduled", "Cardiac assessment", "27-07-2025");
        consultations[5] = new Consultation("CON006", "6", "DOC006", "18-07-2025", "completed", "Mental health evaluation", "28-07-2025");
        consultations[6] = new Consultation("CON007", "7", "DOC007", "19-07-2025", "scheduled", "Skin condition review", "29-07-2025");
        consultations[7] = new Consultation("CON008", "8", "DOC002", "20-07-2025", "completed", "Pediatric consultation", "30-07-2025");
        consultations[8] = new Consultation("CON009", "9", "DOC006", "21-07-2025", "scheduled", "Anxiety treatment follow-up", "31-07-2025");
        consultations[9] = new Consultation("CON010", "10", "DOC005", "22-07-2025", "completed", "Thyroid function test review", "01-08-2025");
        consultations[10] = new Consultation("CON011", "11", "DOC001", "23-07-2025", "scheduled", "Cholesterol management", "02-08-2025");
        consultations[11] = new Consultation("CON012", "12", "DOC003", "24-07-2025", "completed", "Neurological follow-up", "03-08-2025");
    ...
    public static Treatment[] initializeSampleTreatments() {
        ...
        treatments[0] = new Treatment("TRE001", "1", "DOC001", "Hypertension", "MED007", "10-07-2025", "20-07-2025");
        treatments[1] = new Treatment("TRE002", "3", "DOC003", "Migraine", "MED003", "15-07-2025", "30-07-2025");
        treatments[2] = new Treatment("TRE003", "2", "DOC005", "Diabetes Type 2", "MED006", "16-07-2025", "26-07-2025");
        treatments[3] = new Treatment("TRE004", "6", "DOC006", "Depression", "MED009", "18-07-2025", "28-07-2025");
        treatments[4] = new Treatment("TRE005", "4", "DOC005", "Hypothyroidism", "MED004", "19-07-2025", "29-07-2025");
        treatments[5] = new Treatment("TRE006", "8", "DOC002", "Childhood Asthma", "MED008", "20-07-2025", "30-07-2025");
        treatments[6] = new Treatment("TRE007", "9", "DOC006", "Anxiety Disorder", "MED009", "21-07-2025", "31-07-2025");
        treatments[7] = new Treatment("TRE008", "11", "DOC001", "High Cholesterol", "MED010", "23-07-2025", "02-08-2025");
